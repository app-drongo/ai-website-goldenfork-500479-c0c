      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Learn about our journey from a small family dream to Chicago's premier Italian fine dining destination. 
            Meet our passionate team and discover the traditions that make The Golden Fork truly exceptional.
          </p>
        </div>
      </div>
    </section>
