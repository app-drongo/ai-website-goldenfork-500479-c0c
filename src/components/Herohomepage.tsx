        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Indulge in authentic Italian flavors crafted by our award-winning chef. Located in the heart of downtown Chicago, The Golden Fork offers an unforgettable culinary journey.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Elegant dining room at The Golden Fork"
                  fill
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground">Michelin Guide</p>
              <p className="text-sm">
                <span className="font-semibold">★★</span> Recommended
              </p>
            </div>
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground">Wine Spectator</p>
              <p className="text-sm">
                <span className="font-semibold">Award</span> Winner
              </p>
            </div>
          </div>
        </div>
