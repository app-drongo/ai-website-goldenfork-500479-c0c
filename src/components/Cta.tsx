...
import { ArrowRight, Sparkles, Users, Wine, Clock } from "lucide-react"

export default function Cta() {
  const stats = [
    { value: "4.9★", label: "Guest Rating", icon: Users },
    { value: "300+", label: "Wine Selection", icon: Wine },
    { value: "8 Years", label: "Excellence", icon: Sparkles },
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  Chicago's Finest Italian?
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of satisfied guests who have discovered the authentic flavors of Italy 
                in the heart of downtown Chicago. Reserve your table today.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Recognized by Chicago's top food critics and publications
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* Award logos placeholders */}
                  {["Michelin Guide", "Wine Spectator", "Chicago Tribune", "OpenTable", "Zagat"].map((award, i) => (
                    <div 
                      key={i} 
                      className="h-8 w-24 bg-gradient-to-r from-muted to-muted/50 rounded opacity-50 flex items-center justify-center text-xs font-medium"
                    >
                      {award}
                    </div>
                  ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Book online or call us directly for immediate confirmation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Elegant private rooms for special occasions and business dinners
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Wine tastings, chef's table experiences, and seasonal menus
              </p>
            </div>
          </div>
        </div>
