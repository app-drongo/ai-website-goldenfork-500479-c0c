      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Discover our carefully curated menu featuring traditional Italian dishes made with the finest imported ingredients. 
            From handmade pasta to wood-fired pizzas, each dish tells a story of Italy's rich culinary heritage.
          </p>
        </div>
      </div>
    </section>
