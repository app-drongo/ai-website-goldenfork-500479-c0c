...
import { ArrowRight, Calendar, Clock, Users, Wine } from "lucide-react"

export default function Cta1() {
  const stats = [
    { value: "500+", label: "Tables Reserved Monthly", icon: Calendar },
    { value: "4.9★", label: "Average Rating", icon: Wine },
    { value: "15+", label: "Years of Excellence", icon: Clock },
    { value: "200+", label: "Private Events Hosted", icon: Users }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Experience Chicago's finest Italian cuisine in an elegant atmosphere. 
                Book your reservation today and indulge in an unforgettable culinary journey.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured in Chicago's top dining publications
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Elegant private dining rooms for special occasions
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Award-Winning Wine</h3>
              <p className="text-sm text-muted-foreground">
                Curated selection of Italian and international wines
              </p>
            </div>
          </div>
        </div>
