      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            We're here to make your dining experience exceptional. Whether you're planning a romantic dinner, 
            celebrating a special occasion, or organizing a private event, our team is ready to assist you. 
            Contact us for reservations, private dining inquiries, or any questions about our menu and services.
          </p>
        </div>
      </div>
    </section>
